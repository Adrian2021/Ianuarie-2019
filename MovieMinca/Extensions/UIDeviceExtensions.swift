...
extension DeviceModel {
    ...
    case .iPadMini1, .iPadMini2, .iPadMini3, .iPadMini4, .iPadAir1, .iPadAir2,.iPadPro9_7, .iPadPro9_7_cell :
            return CGSize(width: 768, height: 1024)
            
        case .iPadPro10_5, .iPadPro10_5_cell:
            return CGSize(width: 834, height: 1112)
            
        case .iPadPro12_9, .iPadPro12_9_cell:
...
public extension UIDevice {
    public static var model: DeviceModel {
        ...
        // UIDevice.model returneaza modelul de ex iphone 5s
//        1) - withUnsafePointer(to ...>> executa o Closure
//        2) - $0.withMemoryRebound(to: CChar.self, capacity: 1)
//        ...>> leaga pointerul ptr de type-ul CChar
//        3) - ptr in String.init(validatingUTF8: ptr)
//
//        ...>> ptr pointeaza la SystemInfo.machine
